...
/**
 * Checks {@link com.pacificspirit.todo_jersey.webapp.domain.Todo} entity whether it has at least one
...
public @interface AtLeastOneTodo {
    ...
    String message() default "{com.pacificspirit.todo_jersey.webapp.constraint.AtLeastOneTodo.message}";
